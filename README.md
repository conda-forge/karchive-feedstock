...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/karchive-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8468&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/karchive-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8468&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/karchive-feedstock?branchName=main&jobName=linux&configuration=linux_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `karchive` can be installed with `conda`:
...
```
mamba install karchive
```

It is possible to list all of the versions of `karchive` available on your platform with `conda`:
...
```
mamba search karchive --channel conda-forge
```
...
mamba repoquery search karchive --channel conda-forge

# List packages depending on `karchive`:
mamba repoquery whoneeds karchive --channel conda-forge

# List dependencies of `karchive`:
mamba repoquery depends karchive --channel conda-forge
```
